[submission (1).md](https://github.com/user-attachments/files/30226697/submission.1.md)
# บันทึกการแก้โจทย์
...
```text
เริ่มด้วยการรับ input เข้ามาตามโจทย์กำหนด แทนด้วยตัวแปร num, temp, want 
เนื่องจากก่อนที่เราจะแปลงค่าอุณหภูมิได้ เราต้องมีค่ากลาง C ก่อนแล้วค่อยนำค่า C ไปแทนในค่าอุณหภูมิที่ต้องการ โดยแต่ละค่าของ C ก็ต่างกันไป ซึ่งหาได้จากการแปลงค่าจากสมการที่โจทย์กำหนด เลยกำหนดว่าถ้า temp เป็นตัวแปรที่กำหนด(นั่นคือ C, K, F, R)  C จะเป็นยังไง ได้มาทั้งหมด 4 สมการ จะได้สมการหาค่า C เรียบร้อย 
หลังจากเราได้ค่า C  ที่พร้อมไปแปลงค่าในสมการที่โจทย์กำหนดแล้ว เราก็แทนค่า C ตามโจทย์กำหนด   และโจทย์ต้องการคำตอบสมการเป็น 2 ทศนิยม เลยใช้ :.2f ไปด้วย
```
...
```text
รับค่า input ทั้งหมด
แทนค่า c  แล้วนำมาใส่สมการที่โจทย์กำหนดไว้
```
...
คล้ายแผนแรก 
รับ input 
กำหนดค่า c  ตามตัวแปรต่างๆ
นำค่า c ไปแทนค่าในสมการที่โจทย์กำหนดไว้
```
...
```text
เป็นการตรวจสอบเบื้องต้นว่าโค้ดถูกหรือไม่
```
...
```text
เพื่อนช่วยอธิบายคอนเซ็ปต์ของโจทย์ให้ฟังว่า เราต้องหาค่า c มาก่อนจากการย้ายข้างสมการก่อนที่จะแทนลงในสมการที่โจทย์กำหนดไว้
```

คุณยังทำอะไรด้วยตนเอง

```text
เขียนโค้ดเอง และย้ายข้างสมการด้วยตนเอง
```
