...
```text
รับ input ฉลากกินแบ่งของจริงมา ใช้ split แยกตัวอักษร และ ตัวเลข ออกมาจากกัน
ทำแบบเดียวกันกับฉลากที่ซื้อมา
กำหนดเงื่อนไขใช้ if elif elseตามโจทย์กำหนด
เข้าเงื่อนไขไหน print เลขนั้นออกมา
...
```text
รับ input
ใช้ if elif else กำหนดเงื่อนไขตามโจทย์
print คำตอบ
...
```text
ใช้เหมือนแผนแรกไม่มีอะไรเปลี่ยนแปลง
```
...
```text
ดูว่าเงื่อนไขถูกแค่ตัวเลข จะ output ถูกไหม
```
...
```text
ดูว่าไม่เข้าเงื่อนไขอะไรเลย จะ output ถูกไหม
```
