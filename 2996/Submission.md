[submission.md](https://github.com/user-attachments/files/30007364/submission.md)
# บันทึกการแก้โจทย์
...
```text
เริ่มจากสร้างตัวแปรรับข้อความของผู้ใช้ ได้เป็น text = input() เนื่องจากต้องการสลับตัวอักษรจากหน้าไปหลังเป็นหลังไปหน้า ใช้ [-1] และเพื่อความสะดวกจึงแทนด้วยตัวแปร a ได้คำตอบที่ต้องการแล้ว ใช้ print(a)และคำตอบต้องเป็นพิมพ์เล็กทั้งหมด ใช้คำสั่ง .lower()
```
...
```text
เหมือนแผนแรก เริ่มจากสร้างตัวแปรรับข้อความของผู้ใช้ ได้เป็น text = input() เนื่องจากต้องการสลับตัวอักษรจากหน้าไปหลังเป็นหลังไปหน้า ใช้ [-1] และเพื่อความสะดวกจึงแทนด้วยตัวแปร a ได้คำตอบที่ต้องการแล้ว ใช้ print(a)และคำตอบต้องเป็นพิมพ์เล็กทั้งหมด ใช้คำสั่ง .lower()
```
...
```text
เพราะมีตัวพิมพ์ใหญ่ผสม และต้องการคำตอบแค่พิมพ์เล็กเท่านั้น
```
...
```text
เพื่อนคู่ pair ในสัปดาห์ที่ 1
```

เขาช่วยอะไร

```text
ช่วยคิดว่าควรจะเขียนโค้ดอย่างไร
```

คุณยังทำอะไรด้วยตนเอง

```text
เขียนโค้ด และช่วยเพื่อนคิดทำด้วยกัน
```
