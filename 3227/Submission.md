[submission (1).md](https://github.com/user-attachments/files/31429575/submission.1.md)
# บันทึกการแก้โจทย์
...
```text
รับ input ชื่อ card
เปลี่ยนค่า input เป็นพิมพ์ใหญ่ทั้งหมด ได้ตัวแปร cardupper = card.upper()
กำหนดให้มีเซค 1 ถึง 10 ชื่อ num
กำหนดเงื่อนไขโดยใช้ [] บอกตำแหน่ง เช่น cardupper[:-1] คือเอาทุกตัวยกเว้นตัวท้ายสุดที่ใช้วิธีนี้เพราะบางทีเลขมี 2 ตำแหน่งเช่นเลขสิบ ส่วน [-1] คือตัวท้ายสุด
print คำตอบที่ได้
```
