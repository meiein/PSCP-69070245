[submission (4).md](https://github.com/user-attachments/files/30619846/submission.4.md)
...
```text
เริ่มจากการรับ input เข้ามาแทนด้วยตัวแปร day month 
ใช้ if else กำหนดเงื่อนไขตามโจทย์ว่าทุกๆเดือนที่หาร 3 ลง (3, 6, 9, 12) และวันที่ >= 21 จะเป็นฤดูถัดไป
และกำหนดเงื่อนไขปกติของแต่ละเดือนว่าเป็นฤดูอะไร
```
...
```text
เป็นแผนเดิมกับตอนแรก ใช้ if else ดักเงื่อนไขพิเศษ แล้วใช้ if else กำหนดเงื่อนไขธรรมดาว่าแต่ละเดือนเป็นฤดูอะไร
```
...
```text
ดูว่าถ้าวันตรงกับเงื่อนไข แต่เดือนไม่ตรง ยังจะถูกไหม
```
