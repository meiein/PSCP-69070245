...
```text
เริ่มจากการกำหนดขอบเขตของ input ให้มีเพียง 3 สีที่เป็นแม่สีตามที่โจทย์กำหนด และรับ input เข้ามา 2 สี แทนเป็น color1 และ color2 หลังจากรับ input แล้ว กำหนดเงื่อนไขของสีตามที่โจทย์กำหนด เช่น แดง ผสม เหลือง ได้ ส้ม หลังจากกำหนดเงื่อนไขจนครบ ให้แต่ละเงื่อนไข print สีที่ต้องการออกมา หรือ print Error ตามโจทย์กำหนด
```
...
```text
รับ input มาและกำหนดเงื่อนไขโดยใช้ if elif else 
```
...
```text
คล้ายๆแผนแรก แต่ว่าเพิ่มขอบเขตของ input เข้่ามาว่าต้องมีเพียงแค่แม่สี 3 สี นอกจากนั้นทำตามที่คิดไว้ตั้งแต่แรก
```
...
```text
เพราะเป็นการกำหนดตามเงื่อนไขที่โจทย์บอกเบื้องต้น
```
...
```text
เพราะเป็นการกำหนดว่ารับ input ได้แค่สามสีหากเป็นสีอื่นจะไม่สามารถผสมสีด้วยได้
```
...
```text
เป็นการทดสอบว่าสีเดิมผสมกันจะยังคงได้สีเดิม
```
