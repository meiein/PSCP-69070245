[submission (2).md](https://github.com/user-attachments/files/30374196/submission.2.md)
# บันทึกการแก้โจทย์
...
```text
OJ3071 - จำนวนในช่วง [A,B] ที่หารด้วย d เหลือเศษ r
```
...
```text
เริ่มจากรับ input ตามที่โจทย์กำหนดแทนค่าเป็นตัวแปร num1, num2, haan, sed 
เพิ่มตัวแปรค่า count = 0 มารอนับตัวที่ซ้ำ
กำหนดตัวแปร realnum เป็นค่าในช่วง [A,B] ใช้ range วนเป็น เริ่มที่ num1 จบที่ num2+1
คิดค่าตามโจทย์ เลข หาร haan ได้เศษ sed เป็น  realnum % haan == sed ถ้าได้ตามเงื่อนไข count += 1 วนไปเรื่อยๆ
และ print(count) ออกมา
```
...
```text
ตรวจให้ตรงตามเงื่อนไขเบื้องต้น
```
