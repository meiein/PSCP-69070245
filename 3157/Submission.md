[submission (8).md](https://github.com/user-attachments/files/31114790/submission.8.md)
# บันทึกการแก้โจทย์
...
```text
รับ input เข้ามา
กำหนดให้ ans = 0 เพื่อประกาศตัวแปร ans
ใช้ลูปเพื่อวนค่าตามที่รับ input เข้ามา เป็น for i in range(1, num+1)
มี i += 0  เพื่อให้ไม่ติด pep8
รับ input ที่เป็นตัว + - มาอีก แทนว่า math
กำหนดเงื่อนไข if else ว่า ถ้า math เป็น + ให้ans + 10 คะแนน แต่ถ้าเป็น - ให้ ans - 5 คะแนน
และ print คำตอบออกมา
```
...
```text
ดูว่าถ้าเป็น + อย่างเดียวจะถูกไหม
```
