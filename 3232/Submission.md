...
```text
รับ input เป็นจำนวนที่กบกระโดด กับที่อยากให้โดไปถึง ชื่อ start stop
ใช้ while กำหนดเงื่อนไขว่า total jump (นับจำนวนเมตรที่โดดไปทั้งหมด) น้อยกว่า stop จะให้ total jump += start เช่นเริ่ม 0 โดดไป 2 จะได้ total jump เป็น 2 ให้ count += 1 และให้ค่า start -= 2 เพราะกบกระโดดลดลงทีละ 2 เมตร วนไปเรื่อยๆ
ถ้า total jump >= stop ให้ print count ออกมา
ถ้า total count น้อยกว่า stop ให้ print -1
```
...
```text
รับ input 
กำหนดเงื่อนไข ตามโจทย์
ถ้า คำตอบ >=  stop print คำตอบ
ถ้าน้อยกว่า  print -1
```
...
```text
ดูว่าคำตอบมากกว่าจะ print คำตอบไหม
```
...
```text
ดูว่าคำตอบน้อยกว่าจะ print -1 ไหม
```
